               ...
               <div class="table-responsive">
                  <div class="col-sm-7">
                     ...
                     <div class="input-group">
                        <input type="number" onkeyup="validateInp(this);" class="form-control area-input" rows="1" required="" placeholder="Phone"  name="username" id="username" data-error="Input Phone Number" data-error-1="Phone number does not exist!" data-url="<?=base_url('voucher/api_check_phone')?>" value="<?=isset($list) ? $list->cellularphone : ''?>">
                        <span class="input-group-btn">
                           <button type="submit" class="btn btn-primary" style="margin-bottom: 23px;">Check!</button>
                        </span>
                     </div>
                  </div>
               </div>
