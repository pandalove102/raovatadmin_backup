      ...
      <div class="ibox float-e-margins">
         ...
         <div class="ibox-content">
            <div class="table-responsive">
               <div><a class="btn btn-success" style="margin-bottom: 0px;" type="text" href="<?=base_url('attribute/create'); ?>">Add New</a>
                  <table class="table table-striped table-bordered table-hover ">
                     ...
                     <th  style="width: 218px;">Nhãn</th>
                     <th style="width: 218px;">Giá trị mặc định</th>
